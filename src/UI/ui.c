...
void ui_init(void)
{
    ...
    ui_ScreenCalc_screen_init();
    ui_uiScreenCalendar_screen_init();
    ui_uiScreenHealth_screen_init();
...
void ui_destroy(void)
{
    ...
    ui_ScreenCalc_screen_destroy();
    ui_uiScreenCalendar_screen_destroy();
    ui_uiScreenHealth_screen_destroy();
